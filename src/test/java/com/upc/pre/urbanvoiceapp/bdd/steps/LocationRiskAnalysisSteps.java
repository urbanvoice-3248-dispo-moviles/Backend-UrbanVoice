...
public class LocationRiskAnalysisSteps {
    ...
    public void consultoNivelRiesgo() {
        scenarioContext.setLastResponse(restTemplate.getForEntity(
    ...
    private ResponseEntity<LocationResponse> lastResponse() {
        return (ResponseEntity<LocationResponse>) scenarioContext.getLastResponse();
    }
    ...
    public void nivelRiesgoDebeSer(String expectedLevel) {
        ...
        assertEquals(expectedLevel, lastResponse().getBody().getRiskCategory(),
    ...
    public void puntuacionRiesgoDebeSer(int expectedScore) {
        assertEquals(expectedScore, lastResponse().getBody().getRiskLevel(),
